...
**Текущая версия:** 0.5.0 · фазы 0–3 ✅ · фаза 4 начата
...
| [TUI эскиз](luna-shell-tui-sketch.txt) | Welcome-screen, glyph-варианты A–G |
| [Glyph preview](luna-glyphs-preview.txt) | ☾ ◐ braille — сравнить в терминале |
...
| 4 — Luna Shell | 🔶 | welcome 🌙, think, SSH dev |

## Быстрые команды

```bash
docker compose run --rm luna-build-aarch64
# → out/luna-0.5.0-aarch64.iso
```
